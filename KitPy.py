            ...
            for result in results:
                if result.boxes:
                    ...
                    if dd1 == 50:
                        ...
                        time.sleep(2)  # Add a short delay to avoid overwhelming the Arduino with data'''
                        annotated_frame = results[0].plot()

                        cv2.imwrite("alert.jpg", annotated_frame)
                        sendmail()
                        sendmsg("6383164887", "Activity Name:" + object_name +" Loction BHC")
...
def sendmail():
    ...
    toaddr =  "kishorekhanth2005@gmail.com"
...
def main_account_screen():
    ...
    main_screen.title("   Dangerous Action Detection ")

    Label(text="   Dangerous Action Detection", width="300", height="5", font=("Calibri", 16)).pack()
